from csacompendium.research_type.models import ExperimentDetails
...
from csacompendium.research_type.api.experimentdetails.experimentdetailsserializers import experiment_details_serializers
