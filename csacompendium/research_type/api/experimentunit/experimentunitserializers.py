...
from csacompendium.research_type.api.researchexperimentunit.researchexperimentunitserializers \
...
def experiment_unit_serializers():
    ...
    class ExperimentUnitListSerializer(ModelSerializer):
        ...
        """
        url = hyperlinked_identity('research_type_api:experiment_unit_detail', 'slug')
