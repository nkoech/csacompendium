from csacompendium.research_type.models import NitrogenApplied
...
from csacompendium.research_type.api.nitrogenapplied.nitrogenappliedserializers import nitrogen_applied_serializers
